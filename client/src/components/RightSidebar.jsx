      ...
      <div className="bg-[#181818] rounded-xl p-4 border border-[#222]">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {teams.length === 0 ? (
              <div className="text-white/60 text-center py-4">No teams found.</div>
            ) : teams.map(team => (
              <div key={team._id} className="flex items-center justify-between bg-[#232323] rounded-lg px-3 py-2">
                ...
                <Button
                  ...
                  containerClass="bg-white text-black font-zentry font-bold uppercase px-4 py-1 flex items-center gap-2 shadow hover:bg-yellow-200 active:scale-95 transition text-xs"
